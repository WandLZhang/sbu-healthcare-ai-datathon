...
```
sbu-healthcare-ai-datathon/
├── 01-setup/                 # Cline + Claude Code agentic-coder setup (shown at lunch)
├── 02-workshop-materials/    # Colab notebook + any other materials referenced by the slides
├── slides/                   # Marp source — published to GitHub Pages
└── visuals/                  # Screenshots
```
...
> **Disclaimer:** Education and event use only. The CMS Synthetic Patient Data and IDC datasets used here are fully public on `bigquery-public-data`. Do not upload PHI into Qwiklabs projects.
